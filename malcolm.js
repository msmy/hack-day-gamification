...
(function() {
    ...
    addAchievements = function() {
        ...
        var icon = '<div id="first" title="bronze status" style="opacity: 0.5; width: 100px; height: 100px; vertical-align: top; display: inline-block; background-size: cover; background-image:url(http://localhost.nowtv.com:8080/images/zombie-badge-1.png)"></div>';
        var icon2 = '<div title="silver status" style="opacity: 0.5; width: 100px; height: 100px; vertical-align: top; display: inline-block; background-size: cover; background-image:url(http://localhost.nowtv.com:8080/images/zombie-badge-2.png)"></div>';
        var icon3 = '<div title="gold status" style="opacity: 0.5; width: 100px; height: 100px; vertical-align: top; display: inline-block; background-size: cover; background-image:url(http://localhost.nowtv.com:8080/images/zombie-badge-3.png)"></div>';
